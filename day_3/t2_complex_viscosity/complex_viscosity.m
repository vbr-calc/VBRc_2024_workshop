function [eta_star, eta_star_bar, eta_app] = complex_viscosity(J1, J2, omega, etao, maxwell_time);
    ...
    %
    % calculate the complex viscosity following Lau and Holtzman 2019,
    % https://doi.org/10.1029/2019GL083529
    %
    % Parameters
    % ----------
    % J1
    %   real part of complex compliance. Assumes frequency dependence is stored
    %   in final index.
    % J2
    %   imaginary part of complex compliance. Assumes frequency dependence is stored
    %   in final index.
    % omega
